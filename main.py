...
We present LSTM, GWO-LSTM, and CEEMDAN-SE-GWO-LSTM here. 
"""
import os
import numpy as np
...
def plot_results(y_true, y_preds, names, periods = periods, filepath = None):
	...
	"""
	d = '2019-9-25 3:14'
	x = date_range(d, periods = periods, freq = "15min")
...
def main():
	...
	gwo_lstm = load_model('model/gwo_lstm.h5')
	...
	real = read_csv(file2).T.values.tolist()[1][2304:2880]
	pred = []
